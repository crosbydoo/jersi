<template>
    <main>
        <div class="relative pt-16 pb-32 flex items-center justify-center min-h-screen bg-center bg-cover"
            ...
            <div class="container mx-auto relative sm:mx-auto">
                <div class="w-full lg:w-6/12 px-4 mx-auto text-center ">
                    ...
                    <h1 class="text-white font-bold text-4xl md:text-6xl">Muda - Mudi Jersi</h1>
                    <p class="mt-4 text-xl md:text-2xl text-white">Tarunata Eka Dharma Mukti</p>
        ...
        <section class="pb-20 bg-teal-300 -mt-24">
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap items-center mt-32">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        <div
                            class="text-white p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-green-400">
                            <i class="fas fa-user-friends text-xl"></i>
                        </div>
                        <h3 class="text-3xl mb-2 font-semibold leading-normal">
                            Berinovasi Bersama Tanpa Batas
                        </h3>
                        ...
                        <a href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit#/presentation"
                            ...
                            Mari Wujudkan Kreativitas Tanpa Batas!
                        </a>
                    </div>
                    <div class="w-full lg:w-4/12 md:w-6/12 px-4 mr-auto ml-auto">
                        <div
                            class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-green-400">
                            <img alt="Ketua KT Cahaya Muda Juwono"
                                src="https://cdn.discordapp.com/attachments/1104115558649176094/1138301275642011859/IMG_8499_1306x2256-min_1306x1356.webp"
        ...
        <section class="relative py-20 flex bg-white">
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap items-center">
                    <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
                        <div
                            ...
                            <blockquote class="relative p-8 mb-4 text-white">
                                <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95"
                                    class="absolute left-0 w-full block" style="height: 95px; top: -94px;">
                                    <polygon points="-30,95 583,95 583,65" class="text-sky-500 fill-current rounded-lg">
                                    </polygon>
                                </svg>
                    ...
                    <div class="w-full md:w-6/12 lg:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">
                            <div
                                class="text-white p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-sky-500">
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap justify-center text-center mb-20">
                    <div class="w-full lg:w-6/12 px-4">
                        <h2 class="text-4xl font-semibold">Program Kegiatan</h2>
                        <p class="text-lg leading-relaxed m-4 text-gray-600">
                            Beberapa kegiatan yang telah kami laksanakan.
                        </p>
                    </div>
                </div>
                <div class="flex flex-wrap justify-between items-center">
                    <div class="w-full md:w-6/12 lg:w-4/8 lg:mb-12 mb-12 px-4">
                        <div class="px-6">
                            <img alt="Foto Upacara Bendera"
                                src="https://cdn.discordapp.com/attachments/1104115558649176094/1138715037234634782/upacara-min_720x479.webp"
                                class="shadow-lg rounded max-w-full mx-auto sm:max-w-sm md:max-w-xs lg:max-w-md xl:max-w-xl" />
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Upacara Bendera</h5>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-6/12 lg:w-4/8 lg:mb-12 mb-12 px-4">
                        <div class="px-6">
                            <img alt="Foto Senam Sehat"
                                src="https://cdn.discordapp.com/attachments/1104115558649176094/1138714798691979374/IMG_8597_720x479.webp"
                                class="shadow-lg rounded max-w-full mx-auto sm:max-w-sm md:max-w-xs lg:max-w-md xl:max-w-xl" />
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Senam Sehat</h5>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-6/12 lg:w-4/8 lg:mb-12 mb-12 px-4">
                        <div class="px-6">
                            <img alt="Foto Rekreasi"
                                src="https://cdn.discordapp.com/attachments/1104115558649176094/1138715601687289856/IMG_2056_720x480.webp"
                                class="shadow-lg rounded max-w-full mx-auto sm:max-w-sm md:max-w-xs lg:max-w-md xl:max-w-xl" />
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Rekreasi</h5>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-6/12 lg:w-4/8 lg:mb-12 mb-12 px-4">
                        <div class="px-6">
                            <img alt="Foto Rekreasi"
                                src="https://cdn.discordapp.com/attachments/1104115558649176094/1138718329230606397/IMG_1764_720x480.webp"
                                class="shadow-lg rounded max-w-full mx-auto sm:max-w-sm md:max-w-xs lg:max-w-md xl:max-w-xl" />
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Gotong Royong</h5>
                            </div>
                        </div>
                    </div>
                </div>
